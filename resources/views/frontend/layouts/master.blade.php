...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ mix('css/frontend_all.css') }}" >
    ...
    <div class="row">
        <div class="col-lg-8 col-md-8 col-sm-8">
            <div class="slick_slider">
                ...
                <div class="single_iteam"> <a href="#"> <img src="{{ asset('/') }}images/slider_img1.jpg" alt=""></a>
                    <div class="slider_article">
                        <h2><a class="slider_tittle" href="#">Fusce eu nulla semper porttitor felis sit amet</a></h2>
                        <p>Nunc tincidunt, elit non cursus euismod, lacus augue ornare metus, egestas imperdiet nulla nisl quis mauris. Suspendisse a pharetra urna. Morbi dui...</p>
                    </div>
            ...
            <div class="left_content">
                <div class="single_post_content">
                    ...
                    <div class="single_post_content_right">
                        <ul class="spost_nav">
                            ...
                            <li>
                                <div class="media wow fadeInDown"> <a href="#" class="media-left"> <img alt="" src="{{ asset('/') }}images/post_img2.jpg"> </a>
                                    <div class="media-body"> <a href="#" class="catg_title"> Aliquam malesuada diam eget turpis varius 2</a> </div>
                                </div>
                            </li>
                            <li>
                ...
                <div class="single_post_content">
                    ...
                    <ul class="photograph_nav  wow fadeInDown">
                        ...
                        <li>
                            <div class="photo_grid">
                                <figure class="effect-layla"> <a class="fancybox-buttons" data-fancybox-group="button" href="{{ asset('/') }}images/photograph_img3.jpg" title="Photography Ttile 1"> <img src="{{ asset('/') }}images/photograph_img3.jpg" alt=""/> </a> </figure>
                            </div>
                        </li>
                        <li>
                            <div class="photo_grid">
                                <figure class="effect-layla"> <a class="fancybox-buttons" data-fancybox-group="button" href="{{ asset('/') }}images/photograph_img4.jpg" title="Photography Ttile 1"> <img src="{{ asset('/') }}images/photograph_img4.jpg" alt=""/> </a> </figure>
                            </div>
                        </li>
                        <li>
                            <div class="photo_grid">
                ...
                <div class="single_post_content">
                    ...
                    <div class="single_post_content_left">
                        <ul class="business_catgnav">
                            <li>
                                <figure class="bsbig_fig  wow fadeInDown"> <a class="featured_img" href="#"> <img src="{{ asset('/') }}images/featured_img1.jpg" alt=""> <span class="overlay"></span> </a>
                                    <figcaption> <a href="#">Proin rhoncus consequat nisl eu ornare mauris</a> </figcaption>
                                    <p>Nunc tincidunt, elit non cursus euismod, lacus augue ornare metus, egestas imperdiet nulla nisl quis mauris. Suspendisse a phare...</p>
                                </figure>
                            </li>
...
<script src="{{ mix('js/frontend_all.js') }}"></script>
</body>
</html>
